...
var isRepeat = 0;
for (var i = 0; i < len; i++) {
    if (stag[i].src.indexOf('805796785577570304') > -1) {
        isRepeat += 1;
        if (isRepeat >= 2) break;
    }
}
...
let data = {
    ...
    sg: 'tFvSh5tUlJ1qcGuXZWqXaZZkm26YZWtgYYSQV6WFcFlqcJeYkmOcmWZsaJJlWI5TxVWcWpthbGdqmJttZphtbm5wkpiRZoWQWK5anFdukmaYbJhulWNtZWmUlmVhlmhZZVvRh5tUl5xYtg==',
    rid: this.storage.rid() || '',
    d: 'amZpkGdlaZCUmpSPlmSZ'
};
let xhr;
this.storage.rid('2Mydj2FtlmlpmZRlmmyYZWlol2tsZ2I=');
this.request.post('//api.wukongtongji.com/r?t=1753119503000&p=1947350458519654400', data);
...
uuid: function (k, v) {
    if (!k) {
        k = 'st_0e679aae30f99e45ff5e05b9c0f973d1'
    }
    if (!v) {
        v = 'aHCYm5aXZZpmcW1ka5xpZWhlY5Nmb21sYWJslppslWRn'
    }
...
sid: function (k, v) {
    if (!k) {
        k = 'st_aef97c8d553eae1a2a636b9a7ab351e6'
    }
    if (!v) {
        v = 'pZbXqc.jnqzKwWZqZXBrZ5VoaWpplmmbZ2lkkWk='
    }
...
pc: function (k) {
    if (!k) {
        k = 'st_964ff651854d075b4200f217b9e154bf'
    }
...
rid: function (v) {
    ...
    var k = 'st_180d751c9109ee737bb5760ddfffa928';
    if (v !== null) {
        sessionStorage.setItem(k, v);
        return;
    }
